...
(function () {
  ...
  Runner.prototype = {
    ...
    init: function () {
      ...
      this.instructionsContainer.className = Runner.classes.INSTRUCTIONS;
      this.instructionsContainer.textContent =
        "PRESS SPACEBAR OR UP-ARROW TO START";
      this.containerEl.appendChild(this.instructionsContainer);
      ...
      if (e.target != this.detailsButton) {
        if (
          ...
          if (!this.activated) {
            ...
            this.activated = true;
            if (
              document.querySelector(".instructions").style.display.includes("")
            ) {
  ...
  function Obstacle(
    ...
    this.hSize =
      this.typeConfig.type === Obstacle.types[0].type
        ? getRandomNum(1, Obstacle.SMALL_OBSTACLE_LENGTH)
        : getRandomNum(1, Obstacle.LARGE_OBSTACLE_LENGTH);
    // this.hSize = getRandomNum(1, 16);
  ...
  Obstacle.SMALL_OBSTACLE_LENGTH = 11;
  Obstacle.LARGE_OBSTACLE_LENGTH = 3;
  /**
  ...
  (Obstacle.MAX_OBSTACLE_LENGTH = 3),
    (Obstacle.prototype = {
      ...
      draw: function () {
        ...
        var sourceY = sourceHeight * (this.hSize - 1);
        this.canvasCtx.drawImage(
          this.image,
          sourceX,
          sourceY,
       ...
       */
      isVisible: function () {
        return this.xPos + this.width > 0 && this.xPos + this.width < 600;
      },
      /**
  ...
  Trex.prototype = {
    ...
    update: function (deltaTime, opt_status) {
      ...
      if (opt_status) {
        ...
        if (!this.jumping) {
          this.msPerFrame = Trex.animFrames[Trex.status.RUNNING].msPerFrame;
          this.currentAnimFrames = Trex.animFrames[Trex.status.RUNNING].frames;
        }
      }
